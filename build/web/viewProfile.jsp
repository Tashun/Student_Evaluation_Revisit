...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="viewProfile.jsp" class="w3-bar-item w3-button w3-padding-large w3-hide-small w3-orange">VIEW PROFILE</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  <a href="viewProfile.jsp" class="w3-bar-item w3-button w3-padding-large w3-orange">VIEW PROFILE</a>
